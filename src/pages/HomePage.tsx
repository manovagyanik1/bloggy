...
import { ArrowRight, Wand2, Sparkles, Zap } from 'lucide-react';
...
export function HomePage() {
  ...
  const structuredData = {
    ...
    description:
      'AI-powered blog content generator that helps create SEO-optimized blog posts in minutes',
    operatingSystem: 'Web',
    offers: {
      '@type': 'Offer',
      price: '0',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform your ideas into engaging, SEO-optimized blog posts with Bloggy's AI-powered content generator. Create professional content in minutes."
        />

        {/* OpenGraph tags */}
        <meta
          property="og:title"
          content="Bloggy - AI Blog Generator | Create SEO-Optimized Content in Minutes"
        />
        <meta
        ...
        <meta
          ...
          content="Create SEO-optimized blog posts in minutes with AI assistance."
        />
        ...
        <meta
          name="keywords"
          content="AI blog generator, content creation, SEO optimization, blog writing, artificial intelligence, content marketing, blogging tool"
        />
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Create engaging, SEO-optimized blog content in minutes. Let AI handle the writing
        ...
        <div className="py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-base font-semibold leading-7 text-indigo-400">Faster blogging</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Everything you need to create amazing blog content
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Our AI-powered platform helps you create, optimize, and manage your blog content
                with ease.
              </p>
            </div>
            <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                ...
                <div className="flex flex-col">
                  ...
                  <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-300">
                    <p className="flex-auto">
                      Automatically optimize your content for search engines with smart metadata
                      generation.
                    </p>
                  </dd>
                </div>
